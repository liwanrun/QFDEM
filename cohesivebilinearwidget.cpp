...
#include "ui_cohesivebilinearwidget.h"
#include "mechanicalconstitutivemodel.h"

#include <QtVariantProperty>

CohesiveBilinearWidget::CohesiveBilinearWidget(QWidget *parent) :
    ConstitutiveModelWidget(parent),
    ui(new Ui::CohesiveBilinearWidget)
{
    ui->setupUi(this);
    ...
    connect(this->manager, &QtVariantPropertyManager::valueChanged,
            this, &CohesiveBilinearWidget::slotPropertyValueChanged);
}

CohesiveBilinearWidget::~CohesiveBilinearWidget()
{
    delete this->manager;
    delete this->factory;
...
void CohesiveBilinearWidget::CreateConstitutiveProperty(ConstitutiveModel *constitutive)
{
    this->model = static_cast<CohesiveBilinearModel*>(constitutive);
...
void CohesiveBilinearWidget::SetPropertyVisibility(const QString &id, bool visible)
{
...
void CohesiveBilinearWidget::SetBackgroundColor(const QColor &color)
{
...
void CohesiveBilinearWidget::slotPropertyValueChanged(QtProperty *property, const QVariant &value)
{
