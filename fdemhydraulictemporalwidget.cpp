...
#include "ui_fdemhydraulictemporalwidget.h"
#include "temporal.h"

#include <QtVariantProperty>

FDEMHydraulicTemporalWidget::FDEMHydraulicTemporalWidget(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::FDEMHydraulicTemporalWidget)
{
    ui->setupUi(this);
...
FDEMHydraulicTemporalWidget::~FDEMHydraulicTemporalWidget()
{
    delete this->factory;
    delete this->manager;
...
void FDEMHydraulicTemporalWidget::InitPropertyBrowser()
{
    this->CreateInitialConditionProperty();
    this->CreateInitialSpatialOptionProperty();
}

void FDEMHydraulicTemporalWidget::ConnectSignalSlots()
{
    connect(this->manager, &QtVariantPropertyManager::valueChanged,
            this, &FDEMHydraulicTemporalWidget::slotPropertyBrowserValueChanged);
    connect(ui->spaceTableWidget, &QTableWidget::itemChanged,
            this, &FDEMHydraulicTemporalWidget::slotSpatialTableWidgetItemChanged);
}

void FDEMHydraulicTemporalWidget::UpdatePropertyBrowser(HydraulicTemporal *temp)
{
    this->temporal = temp;
...
void FDEMHydraulicTemporalWidget::SetPropertyVisibility(const QString &id, bool visible)
{
...
void FDEMHydraulicTemporalWidget::SetPropertyExpanded(const QString &id, bool expanded)
{
    QtVariantProperty *property;
    property = static_cast<QtVariantProperty*>(manager->qtProperty(id));
...
void FDEMHydraulicTemporalWidget::CreateInitialConditionProperty()
{
    ...
    ui->treeBrowser->setBackgroundColor(bvpItem, QColor(191, 255, 255));
}

void FDEMHydraulicTemporalWidget::CreateInitialSpatialOptionProperty()
{
...
void FDEMHydraulicTemporalWidget::UpdateInitialConditionProperty()
{
    QtVariantProperty *property;
...
void FDEMHydraulicTemporalWidget::UpdateInitialSpatialOptionProperty()
{
    QtVariantProperty *property;
...
void FDEMHydraulicTemporalWidget::slotPropertyBrowserValueChanged(QtProperty *property, const QVariant &value)
{
...
void FDEMHydraulicTemporalWidget::slotSpatialTableWidgetItemChanged(QTableWidgetItem *item)
{
    item->setTextAlignment(Qt::AlignVCenter | Qt:: AlignRight);
