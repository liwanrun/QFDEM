...
#include "ui_trianglehookeanelasticitywidget.h"
#include "mechanicalconstitutivemodel.h"

#include <QtVariantProperty>

TriangleHookeanElasticityWidget::TriangleHookeanElasticityWidget(QWidget *parent) :
    ConstitutiveModelWidget(parent),
    ui(new Ui::TriangleHookeanElasticityWidget)
{
    ui->setupUi(this);
    ...
    connect(this->manager, &QtVariantPropertyManager::valueChanged,
            this, &TriangleHookeanElasticityWidget::slotPropertyValueChanged);
}

TriangleHookeanElasticityWidget::~TriangleHookeanElasticityWidget()
{
    delete this->manager;
    delete this->factory;
...
void TriangleHookeanElasticityWidget::CreateConstitutiveProperty(ConstitutiveModel *constitutive)
{
    this->model = static_cast<HookeanElasticityModel*>(constitutive);
...
void TriangleHookeanElasticityWidget::SetPropertyVisibility(const QString &id, bool visible)
{
...
void TriangleHookeanElasticityWidget::SetBackgroundColor(const QColor &color)
{
...
void TriangleHookeanElasticityWidget::slotPropertyValueChanged(QtProperty *property, const QVariant &value)
{
